...
public class TokenTest {
  ...
  void makingAccessToken()
    ...
    assertAll(
        ...
        () -> assertThat(tesetJWTProvider.getSECREAT_KEY()).isEqualTo(
            "thisistestsecretkeyformakingtokenbuthavetolongerthen256bitscausethisalgorithmishs256"),
  ...
  void getTokenIngredient() {
    ...
    assertAll(
        () -> assertThat(tesetJWTProvider.getTokenIngredientFromToken(token)).isEqualTo(
            new TokenIngredient("test@maver.com", 0))
    );
  }
}
